...
function DockItem({
  ...
  const mouseDistance = useTransform(orientation === "horizontal" ? mouseX : mouseY, (val) => {
...
export default function Dock({
  ...
  return (
    <div
      className={`dock-outer ${orientation === "vertical" ? "dock-vertical" : ""}`}
    >
      <div
        ...
        className={`dock-panel ${className} ${orientation === "vertical" ? "dock-panel-vertical" : ""}`}
        style={{ 
